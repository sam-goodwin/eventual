...
import { ChaosRule } from "./chaos-layer/chaos-engine.js";
import { SSMChaosClient } from "./chaos-layer/chaos-client.js";
...
const chaosClient = new SSMChaosClient(chaosSSMParamName());
